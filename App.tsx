...
const App: React.FC = () => {
  ...
  // Standard Tailwind classes are static and cannot handle this type of dynamic styling.
  const spotlightStyle: React.CSSProperties = {
    WebkitMaskImage: `radial-gradient(circle 150px at ${mousePosition.x}px ${mousePosition.y}px, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%)`,
    maskImage: `radial-gradient(circle 150px at ${mousePosition.x}px ${mousePosition.y}px, rgba(0,0,0,1) 0%, rgba(0,0,0,0) 100%)`,
  };
  ...
  return (
    <div className="h-screen w-screen bg-black text-white antialiased overflow-hidden cursor-none relative">
      ...
      >
       ...
       {/* Custom cursor to enhance the spotlight illusion */}
      <div 
